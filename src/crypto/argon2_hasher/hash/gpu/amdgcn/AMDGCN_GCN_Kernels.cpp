...
string AMDGCN_GCN_Kernels = R"GCN(
.ifarch GCN1.4
    HASH = %s10
...
.kernel fill_blocks
    .config
        ...
        .arg refs, uint*, global                # loaded in s[4:5]
        .arg idxs, uint*, global                # loaded in s[4:5]
        .arg segments, uint*, global            # loaded in s[6:7]
        .arg memsize, int                       # loaded in s9
        .arg lanes, int                         # loaded in s9
        .arg seg_length, int                    # loaded in s9
        .arg seg_count, int                     # loaded in s9
        .arg threads_per_chunk, int             # loaded in s9
        .arg thread_idx, int                    # loaded in s9
    .text
        s_mov_b32 m0, 0xffff
